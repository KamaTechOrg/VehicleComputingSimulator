...
inline const char *toString(ErrorCode error)
{
    switch (error) {
        ...
        case ErrorCode::CLOSE_FAILED:
            return "CLOSE_FAILED";
        case ErrorCode::CALLBACK_ERROR:
            return "CALLBACK_ERROR";
        case ErrorCode::SOCKET_INTERFACE_ERROR:
            return "SOCKET_INTERFACE_ERROR";
        ...
        case ErrorCode::DISCONNECT_FAILED:
            return "DISCONNECT_FAILED";
        case ErrorCode::INVALID_DATA_SIZE:
