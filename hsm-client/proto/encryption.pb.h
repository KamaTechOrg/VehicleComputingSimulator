...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2fencryption_2eproto;
namespace crypto {
...
class AsymetricDecryptResponse final :
 ...
 public:
  ...
  void clear_decryptedlength();
  ::PROTOBUF_NAMESPACE_ID::int32 decryptedlength() const;
  void set_decryptedlength(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_decryptedlength() const;
  void _internal_set_decryptedlength(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 decryptedlength_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_proto_2fencryption_2eproto;
};
// -------------------------------------------------------------------
...
// int32 decryptedLength = 2;
inline void AsymetricDecryptResponse::clear_decryptedlength() {
  decryptedlength_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 AsymetricDecryptResponse::_internal_decryptedlength() const {
  return decryptedlength_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 AsymetricDecryptResponse::decryptedlength() const {
  // @@protoc_insertion_point(field_get:crypto.AsymetricDecryptResponse.decryptedLength)
  return _internal_decryptedlength();
}
inline void AsymetricDecryptResponse::_internal_set_decryptedlength(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  decryptedlength_ = value;
}
inline void AsymetricDecryptResponse::set_decryptedlength(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_decryptedlength(value);
  // @@protoc_insertion_point(field_set:crypto.AsymetricDecryptResponse.decryptedLength)
}
...
// int32 length = 1;
inline void GetLengthResponse::clear_length() {
  length_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 GetLengthResponse::_internal_length() const {
  return length_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 GetLengthResponse::length() const {
  // @@protoc_insertion_point(field_get:crypto.GetLengthResponse.length)
  return _internal_length();
}
inline void GetLengthResponse::_internal_set_length(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  length_ = value;
}
inline void GetLengthResponse::set_length(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_length(value);
  // @@protoc_insertion_point(field_set:crypto.GetLengthResponse.length)
}
...
// int32 decryptedLength = 2;
inline void DecryptResponse::clear_decryptedlength() {
  decryptedlength_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 DecryptResponse::_internal_decryptedlength() const {
  return decryptedlength_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 DecryptResponse::decryptedlength() const {
  // @@protoc_insertion_point(field_get:crypto.DecryptResponse.decryptedLength)
  return _internal_decryptedlength();
}
inline void DecryptResponse::_internal_set_decryptedlength(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  decryptedlength_ = value;
}
inline void DecryptResponse::set_decryptedlength(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_decryptedlength(value);
  // @@protoc_insertion_point(field_set:crypto.DecryptResponse.decryptedLength)
}
...
// int32 decryptedLength = 2;
inline void AESDecryptResponse::clear_decryptedlength() {
  decryptedlength_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 AESDecryptResponse::_internal_decryptedlength() const {
  return decryptedlength_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 AESDecryptResponse::decryptedlength() const {
  // @@protoc_insertion_point(field_get:crypto.AESDecryptResponse.decryptedLength)
  return _internal_decryptedlength();
}
inline void AESDecryptResponse::_internal_set_decryptedlength(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  decryptedlength_ = value;
}
inline void AESDecryptResponse::set_decryptedlength(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_decryptedlength(value);
  // @@protoc_insertion_point(field_set:crypto.AESDecryptResponse.decryptedLength)
}
