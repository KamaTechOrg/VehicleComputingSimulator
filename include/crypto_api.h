...
// geneate key pair to each coponnet cinfigure the
...
CK_RV encrypt(int senderId, int receiverId, void *in, size_t inLen, void *out,
              size_t outLen,void * signature,size_t signatureLen, size_t counter);

CK_RV decrypt(int senderId, int receiverId, void *in, size_t inLen,void * signature,size_t signatureLen, void *out,
