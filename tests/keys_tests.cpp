...
#include <filesystem>
#include <nlohmann/json.hpp>
#include "../include/hsm.h" // Include your HSM header file
...
TEST(HsmTests, CompareWithDataFileTest) {
    ...
    std::vector<KeyPermission> permissions = {KeyPermission::VERIFY, KeyPermission::SIGN};
    ...
    ASSERT_EQ(generatedKeyContent, expectedKeyContent) << "Key content does not match expected data";
