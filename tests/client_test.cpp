...
#include "../communication/src/client.h"
#include "../communication/sockets/mock_socket.h"
#include "../communication/src/message.h"
...
protected:
    ...
    void SetUp() override {
        ...
        client = new Client([](Packet &){}, &mockSocket);
    }
...
TEST_F(ClientTest, ReceivePacketSuccess) {
    ...
    client->connectToServer(1);
    std::thread receiveThread(&Client::receivePacket, client);
    receiveThread.join();
